 ...
 * Minimal, clean, restrained retro footer matching the warm paper aesthetic.
 */
export function Footer() {
  return (
    <footer className="w-full border-t-2 border-[#2b2520] bg-[#fffef9] py-6 px-4 text-center text-xs text-[#7d7366]">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-2">
        ...
        <div className="mt-1 text-[10px] text-[#aaa092]">
